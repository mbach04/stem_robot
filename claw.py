...
# Rii Mini X1 - Note, the keys are the same as the iPazz,
# but the vendor / device IDs are completely different
# ID 1997:2433
elif usb.core.find(idVendor=0x1997, idProduct=0x2433):
